...
test.describe("Item", () => {
  test("should allow me to mark items as complete", async ({ page }) => {
    ...
    // Create two items.
    for (const item of todos.slice(0, 2)) {
...
test.describe("Editing", () => {
  ...
  test("should remove the item if an empty text string was entered", async ({
    ...
    await expect(todoItems).toHaveText([todos[0], todos[2]]);
  });
...
test.describe("Persistence", () => {
  test("should persist its data", async ({ page }) => {
    ...
    await expect(todoItems).toHaveText([todos[0], todos[1]]);
...
test.describe("Routing", () => {
  test.beforeEach(async ({ page }) => {
    ...
    await checkTodosInLocalStorage(page, todos[0]);
  });
  ...
  test("should allow me to display active items", async ({ page }) => {
    ...
    await expect(todoItem).toHaveText([todos[0], todos[2]]);
  });
