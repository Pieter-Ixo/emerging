...
type IconProp = { stroke: string; fill: string };

const colors: Record<Status, IconProp> = {
  disabled: { stroke: palette.Neutral800, fill: palette.Neutral200 },
  selected: { stroke: palette.White, fill: palette.fullBlue },
  notSelected: { stroke: palette.Black, fill: palette.Neutral200 },
};
...
function PortfolioIcon(props: Props) {
  ...
  return (
    <svg
      ...
      {...svgProps}
    >
      <rect y="0.5" width="46" height="46" rx="23" fill={color.fill} />
      <path
