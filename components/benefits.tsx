	...
	return (
		<div className={utilsStyles.pageContainer}>
			<Head>
				...
				<meta name="description" content="Supamoto Benefist - Explore the benefits and impact of the Supamoto Cookstoves" />
			</Head>
			...
			<main className={utilsStyles.pageWidth}>
				...
				<section className={utilsStyles.column}>
					<div className={utilsStyles.flex}>
						...
						/>
						<BenefitsCard
							images={['/images/family.png', '/images/bowl.png', '/images/heart-rate.png', '/images/genders.png', '/images/power.png', '/images/eye-earth.png']}
